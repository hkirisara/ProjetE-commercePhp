		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total item">Somme total</th>
					<th class="cart-total item">Methode de Payment</th>
...
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">L'id de commande ou e-mail enregistré n'est pas valide</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
