		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total">Somme total</th>
					<th class="cart-total item">Methode Payment </th>
...
?>
				<tr>
					...
					<td><a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">Supprimer</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Procéder au paiement</a></button>
